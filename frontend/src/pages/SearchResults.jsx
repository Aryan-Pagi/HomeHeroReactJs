...
function SearchResults() {
      ...
      try {
        ...
        if (userLocation && radiusKm) {
          filteredResults = filteredResults.filter((provider) => {
            ...
            const providerCoords = getLocationCoordinates(provider.user?.location);
            if (providerCoords) {
  ...
  const getLocationCoordinates = (location) => {
    const coords = {
      ...
      "Calangute": { lat: 15.5440, lng: 73.7551 },
              ...
              >
                <div className="p-8 flex flex-col md:flex-row gap-6">
                  <div className="shrink-0">
                    <div className="w-full md:w-56 h-56 rounded-xl ring-4 ring-cyan-100 shadow-md bg-gradient-to-br from-cyan-100 to-blue-100 flex items-center justify-center">
                  ...
                  <div className="flex-1 flex flex-col">
                    ...
                    <div className="flex items-center justify-between pt-4 border-t-2 border-gray-100">
                      ...
                      <button className="bg-gradient-to-r from-cyan-500 to-cyan-600 hover:from-cyan-600 hover:to-cyan-700 text-white px-6 py-3 rounded-xl font-bold transition-all duration-200 shadow-md hover:shadow-lg transform hover:scale-105">
                        View Profile
                      </button>
                    </div>
                  </div>
